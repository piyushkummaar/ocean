# Generated by Django 3.0.2 on 2020-03-28 08:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('refer_account_id', models.CharField(blank=True, default=4251213147, max_length=120)),
                ('refer_account_name', models.CharField(blank=True, max_length=30)),
                ('user_id', models.CharField(default=57156498, max_length=120)),
                ('country', django_countries.fields.CountryField(max_length=2)),
                ('role', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'User'), (2, 'Active'), (3, 'Star'), (4, 'Silver'), (5, 'Gold'), (6, 'Platinum'), (7, 'Diamond')], default=1, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='UserMembership',
